...
const Learn = () => {
  return (
    ...
    <>
      <title>Greek Alphabet Lessons and Exercises</title>

      <meta
        name="description"
        content="Learn to read the Modern Greek alphabet through 17 beginner lessons with pronunciation guides, examples and interactive exercises."
      />
