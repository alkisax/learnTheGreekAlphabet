const GreekAlphabet = () => {
  return (
    <>
      <title>The Greek Alphabet: History and Pronunciation</title>

      <meta
        name="description"
        content="Learn about the history, letters, writing direction and pronunciation of the Greek alphabet in a simple guide for beginners."
      />
      ...
      <main>
        <h1 className="mb-6 text-4xl font-bold">The Greek Alphabet for beginners</h1>
        ...
        <div className="space-y-4 text-lg leading-8">
          ...
          <p>
            Modern Greek is written from left to right. In early Greek inscriptions,
            however, writing could also run from right to left or alternate direction
            on each line. This alternating style is called boustrophedon, meaning “as
            the ox turns while ploughing.”
          </p>
        </div>
      </main>
    </>
