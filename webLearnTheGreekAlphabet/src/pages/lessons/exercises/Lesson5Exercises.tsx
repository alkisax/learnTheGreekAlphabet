...
const exercises: Exercise[] = [
  ...
  },
  {
    ...
    lowercase: "ύλη",
    answer: "Ili",
    meaning: "Material or subject matter",
  },
  {
    uppercase: "ΛΥΠΗ",
    lowercase: "λύπη",
  ...
  return (
    <section className="mt-12">
      ...
      <p className="mb-8 text-gray-300">
        Remember: <strong>ι</strong>, <strong>η</strong> and{" "}
        <strong>υ</strong> all represent the same <strong>i</strong> sound.
      </p>
...
export default Lesson5Exercises