  ...
  return (
    <section className="mt-12">
      ...
      <p className="mb-8 text-gray-300">
        Read <strong>ου</strong> like <strong>oo</strong> in “food”.
      </p>
...
export default Lesson9Exercises