  ...
  return (
    <section className="mt-12">
      ...
      <p className="mb-8 text-gray-300">
        Use <strong>ts</strong> for τσ and <strong>tz</strong> for τζ.
      </p>
