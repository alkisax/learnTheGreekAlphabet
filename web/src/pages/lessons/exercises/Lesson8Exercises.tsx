...
const exercises: Exercise[] = [
  ...
  },
  {
    ...
    lowercase: "ζώνη",
    answer: "ZOni",
    meaning: "Zone or belt",
  },
  {
    uppercase: "ΚΟΣΜΟΣ",
    lowercase: "κόσμος",
    answer: "KOsmos",
    meaning: "World or people",
  },
  {
    uppercase: "ΩΡΑΙΟ",
    lowercase: "ωραίο",
    answer: "oreO",
    meaning: "Beautiful or nice",
  },
  {
    uppercase: "ΟΝΟΜΑ",
    lowercase: "όνομα",
  ...
  return (
    <section className="mt-12">
      ...
      <p className="mb-8 text-gray-300">
        Remember: <strong>ο</strong> and <strong>ω</strong> sound exactly the
        same.
      </p>
...
export default Lesson8Exercises